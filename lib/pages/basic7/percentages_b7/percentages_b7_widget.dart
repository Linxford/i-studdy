...
import 'percentages_b7_model.dart';
export 'percentages_b7_model.dart';

class PercentagesB7Widget extends StatefulWidget {
  const PercentagesB7Widget({super.key});

  @override
  State<PercentagesB7Widget> createState() => _PercentagesB7WidgetState();
}

class _PercentagesB7WidgetState extends State<PercentagesB7Widget> {
  late PercentagesB7Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => PercentagesB7Model());
                                          ...
                                          child: Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    5.0, 0.0, 0.0, 0.0),
                                            child: Text(
                                              'How do we Convert from Percent to Decimal?',
                                              textAlign: TextAlign.start,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .displaySmall
                                          ...
                                          children: [
                                            ...
                                            ClipRRect(
                                              borderRadius:
                                                  BorderRadius.circular(8.0),
                                              child: Image.asset(
                                                'assets/images/Percent-to-Decimal.jpg',
                                                width: double.infinity,
                                                height: 200.0,
                                                fit: BoxFit.fill,
                                              ),
