...
export 'basic7_quiz_model.dart';

class Basic7QuizWidget extends StatefulWidget {
  const Basic7QuizWidget({super.key});

  @override
  State<Basic7QuizWidget> createState() => _Basic7QuizWidgetState();
}

class _Basic7QuizWidgetState extends State<Basic7QuizWidget> {
  late Basic7QuizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Basic7QuizModel());
