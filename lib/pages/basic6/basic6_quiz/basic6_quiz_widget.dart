...
import 'basic6_quiz_model.dart';
export 'basic6_quiz_model.dart';

class Basic6QuizWidget extends StatefulWidget {
  const Basic6QuizWidget({super.key});

  @override
  State<Basic6QuizWidget> createState() => _Basic6QuizWidgetState();
}

class _Basic6QuizWidgetState extends State<Basic6QuizWidget> {
  late Basic6QuizModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => Basic6QuizModel());
                                          ...
                                          Padding(
                                            padding:
                                                const EdgeInsetsDirectional.fromSTEB(
                                                    5.0, 0.0, 5.0, 0.0),
                                            child: Text(
                                              'Q.1: If 16% of 40% of a number is 8, then find the number.\n\nQ.2: What percentage of 2/7 is 1/35 ?\n\nQ.3: A fruit seller had some apples. He sells 40% apples and still has 420 apples. Originally, he had how many apples?\n\nQ.4: Out of two numbers, 40% of the greater number is equal to 60% of the smaller. If the sum of the numbers is 150, then the greater number is?',
                                              textAlign: TextAlign.justify,
                                              style:
                                                  FlutterFlowTheme.of(context)
                                                      .bodyMedium
